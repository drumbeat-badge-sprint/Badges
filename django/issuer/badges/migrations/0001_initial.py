...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'BadgeClaim'
        db.create_table('badges_badgeclaim', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('badge', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['badges.Badge'])),
        ))
        db.send_create_signal('badges', ['BadgeClaim'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'BadgeClaim'
        db.delete_table('badges_badgeclaim')
